					...
					<tr class="row<?php echo $i % 2; ?>">
						...
						<td class="has-context">
							...
							<div class="pull-left" style="width:50%">
								...
								?>
								<?php $reg_params = json_decode($item->params); ?>
								<?php $eventParams = json_decode($item->eventParams); ?>
								<?php if ($reg_params) : ?>
									<div class="">
										<strong><?php echo JText::_('PayPal Payment'); ?></strong>
									</div>
									<div>
										<span class="">
											Registration Status:
									...
									<div>
										...
										<span class="label label-info">
											<?php echo $reg_params->total . ' ' . $reg_params->currency; ?>
										</span>
									</div>
								<?php elseif ((isset($eventParams->registration_payment) && $eventParams->registration_payment == 1)
									|| (isset($eventParams->registration_payment) && $eventParams->registration_payment == '' && JComponentHelper::getParams('com_icagenda')->get('registration_payment', ''))) : ?>
									<div class="small">
										<strong><?php echo JText::_('PayPal Payment'); ?></strong>
									</div>
									<div>
