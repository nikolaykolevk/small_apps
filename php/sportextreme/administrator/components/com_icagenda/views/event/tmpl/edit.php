							...
							<div class="span12">
								...
								<div id="embed_map">
									<?php if ($this->item->address) : ?>
										<?php echo '<iframe width="100%" height="300" frameborder="0" style="border:0;" class="icagenda_map" src="https://www.google.com/maps/embed/v1/place?key=' . $iCparams->get('googlemaps_embed_key', '') . '&q=' . urlencode(strip_tags($this->item->address)) . '" allowfullscreen></iframe>'; ?>
									<?php endif; ?>
								</div>
								<script>
									document.getElementById('jform_address').setAttribute('class', 'input-xxlarge');
