<?php include('system/php/admin/adminServer.php') ?>
<!DOCTYPE html>
<html>
<head>
<title>Login</title>
...
<body class="bg-info">
	...
	<div class="container-fluid pt-4 p-5 text-light bg-info text-center">
		<h2 class="display-3 mb-5">Admin Login</h2>
  	...
  	<?php include('system/php/errors.php'); ?>
			...
			<p>
				Login for <a class="text-light" href="login.php"><b>users</b></a>
			</p>
			<div class="form-group my-3">
				<button type="submit" class="btn btn-dark px-5" name="login_admin">Login</button>
			</div>
		</form>
